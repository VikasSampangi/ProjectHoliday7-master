...
public class ConfigureFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        config4 = (CardView)view.findViewById( R.id.config4 );
        config4.setOnClickListener( this );
        return view;
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.config3:
                ...
                break;
            case R.id.config4:
                startActivity( new Intent( getContext(), InsideTeleList.class ).putExtra( "reference","config4" ) );
                break;
        }
